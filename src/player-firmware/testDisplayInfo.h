...
const char* desc[] = {
  "Franz Liszt (born October 22, 1811, Doborjan, kingdom of Hungary, Austrian Empire [now Raiding, Austria] - died July 31, 1886, Bayreuth, Germany) was a Hungarian piano virtuoso and composer. Among his many notable compositions are his 12 symphonic poems, two (completed) piano concerti, several sacred choral works, and a great variety of solo piano pieces.",
  "Liszt's father, Adam Liszt, was an official in the service of Prince Nicolas Eszterhazy, whose palace in Eisenstadt was frequented by many celebrated musicians. Adam Liszt was a talented amateur musician who played the cello in the court concerts. By the time Franz was five years old, he was already attracted to the piano and was soon given lessons by his father. He began to show interest in both church music and Roma music. He developed into a religious child, also because of the influence of his father, who during his youth had spent two years in the Franciscan order.",
  "Franz began to compose at the age of eight. When only nine he made his first public appearance as a concert pianist at Sopron and Pozsony (now Bratislava, Slovakia). His playing so impressed the local Hungarian magnates that they put up the money to pay for his musical education for the next six years. Adam obtained leave of absence from his post and took Franz to Vienna, where he had piano lessons with Carl Czerny, a composer and pianist who had been a pupil of Ludwig van Beethoven, and studied composition with Antonio Salieri, the musical director at the Viennese court. He gave several concerts in Vienna, with great success. The legend that Beethoven attended one of Liszts concerts and kissed the prodigy on the forehead is considered apocryphal - but Liszt certainly met Beethoven.",
  "Liszt moved with his family to Paris in 1823, giving concerts in Germany on the way. He was refused admission to the Paris Conservatoire because he was a foreigner; instead, he studied with Anton Reicha, a theorist who had been a pupil of Joseph Haydn's brother Michael, and Ferdinando Paer, the director of the Theatre-Italien in Paris and a composer of light operas. Liszt's Paris debut on March 7, 1824, was sensational.",
  "Other concerts quickly followed, as well as a visit to London in June. He toured England again the following year, playing for George IV at Windsor Castle and also visiting Manchester, where his New Grand Overture was performed for the first time. This piece was used as the overture to his one-act opera Don Sanche, which was performed at the Paris Opera on October 17, 1825. In 1826 he toured France and Switzerland, returning to England again in the following year.",
  "Suffering from nervous exhaustion, Liszt expressed a desire to become a priest. His father took him to Boulogne to take sea baths to improve his health; there Adam died of typhoid fever. Liszt returned to Paris and sent for his mother to join him; she had gone back to the Austrian province of Styria during his tours.",
  ...
  "With the July Revolution of 1830 resulting in the abdication of the French king Charles X and the coronation of Louis-Philippe, he sketched out a Revolutionary Symphony.",
  ...
  "In 1834 Liszt emerged as a mature composer with the solo piano piece Harmonies poetiques et religieuses, based on a collection of poems by Alphonse de Lamartine, and the set of three Apparitions. ",
  "The lyrical style of these works is in marked contrast to his youthful compositions, which reflected the style of his teacher Czerny. In the same year, through the poet and dramatist Alfred de Musset, he met the novelist George Sand and also Marie de Flavigny, countess d'Agoult, with whom he began an affair. ",
};